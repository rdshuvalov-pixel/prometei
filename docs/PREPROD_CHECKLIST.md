...
- [ ] Список вакансий: все строки; фильтр **Status = Scored** (`?filter=Scored`); при пустом списке с фильтром проверь воркер/скоринг (значение **`Scored`**, см. stub / полноценный скорер).
